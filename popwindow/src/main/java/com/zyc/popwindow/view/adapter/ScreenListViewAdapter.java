package com.zyc.popwindow.view.adapter;
...
import com.zyc.popwindow.R;
import com.zyc.popwindow.bean.FiltrateBean;
import com.zyc.popwindow.view.SkuFlowLayout;
...
public class ScreenListViewAdapter extends BaseAdapter {
    ...
    public void setRightBtnClick(OnRightBtnClick rightBtnClick) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            vh.rightBtn = convertView.findViewById(R.id.rightBtn);
            vh.inputTxt=convertView.findViewById(R.id.inputTxt);
            convertView.setTag(vh);
        } else {
            vh = (ViewHolder) convertView.getTag();
        }

        final FiltrateBean filtrateBean = dictList.get(position);
        vh.tvTypeName.setText(filtrateBean.getTypeName());
        vh.tvTypeName.setTextColor(titleColor);
        vh.tvTypeName.setTextSize(titleSize);
        vh.rightBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (null != rightBtnClick)
                    rightBtnClick.onClick(vh.inputTxt,filtrateBean);
            }
        });
    ...
    public interface OnRightBtnClick {
        void onClick(EditText view,FiltrateBean filtrateBean);
    }
}
